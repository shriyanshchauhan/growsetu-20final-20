    ...
    <Layout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container grid gap-8 py-20 md:grid-cols-2 md:items-center">
          <div className="space-y-6 animate-slideUp">
            <span className="inline-flex items-center rounded-full bg-secondary px-3 py-1 text-xs font-semibold text-foreground/70">Digital Marketing Agency</span>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight">
              Grow Your Business Online with <span className="text-primary">GrowSetu</span>
            </h1>
            <p className="text-lg text-muted-foreground max-w-prose">
              Helping local businesses build their digital presence with websites, SEO, social media, and branding.
            </p>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            ...
            <Card key={s.title} className="group hover:shadow-lg transition-shadow">
              <CardHeader>
                <div className="inline-flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10">{s.icon}</div>
      ...
      <section className="container py-16">
        <div className="mx-auto mb-8 max-w-2xl text-center">
          ...
          <p className="mt-2 text-muted-foreground">Real stories from growing local businesses.</p>
        </div>
      ...
      <section className="container py-16">
        <div className="rounded-2xl border bg-primary text-primary-foreground p-8 md:p-12 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
          <div>
            ...
            <p className="text-primary-foreground/90">Let’s build your digital presence today.</p>
          </div>
