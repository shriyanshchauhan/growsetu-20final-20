          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border p-6 bg-white">
              ...
              <ul className="space-y-3 text-sm">
                <li className="flex items-center gap-3"><Mail className="h-4 w-4 text-primary" /> <a className="hover:text-primary" href="https://mail.google.com/mail/?view=cm&fs=1&to=work.growsetu@gmail.com&su=Inquiry%20from%20GrowSetu%20Website" target="_blank" rel="noreferrer">work.growsetu@gmail.com</a></li>
