      ...
      <div className="container grid gap-10 py-12 md:grid-cols-4">
        <div className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xs">
            Helping local businesses build their digital presence with modern
          ...
          <ul className="space-y-2 text-sm">
            <li>
              ...
              <a
                ...
                href="mailto:work.growsetu@gmail.com"
              >
        ...
        <div>
          ...
          <div className="flex gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex h-9 w-9 items-center justify-center rounded-full border bg-background hover:bg-primary hover:text-primary-foreground transition-colors"
            >
